...
void copyRGB(u_char* rgbData, u_char* rgbaData,
             int rows, int cols)
{
...
Java_com_example_kevin_opencv_1takephoto_MainActivity_matrixPow(JNIEnv *env, jobject instance,
                                                                jlong m1Data, jlong m2Data,
                                                                jlong dstData, jint size) {
    matrixPow((float*)m1Data, (float*)m2Data,(float*)dstData, (int)size);
    // TODO
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_kevin_opencv_1takephoto_MainActivity_copyRGB(JNIEnv *env, jobject instance,
                                                              jlong rgbData, jlong rgbaData,
                                                              jint rows, jint cols) {
    copyRGB((u_char*) rgbData,(u_char*)rgbaData,
    (int)rows, (int)cols);
    // TODO
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_kevin_opencv_1takephoto_MainActivity_getK(JNIEnv *env, jobject instance,
                                                           jlong tData, jlong outData, jint h,
                                                           jint w) {
    getK((float*)tData,(float*)outData, (int)h, (int)w);
    // TODO
}
...
Java_org_capg_helin_lightenhance_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
